...
def import_data_xml():
    ...
    result, status_code = db.import_transactions_from_camt053_sample()
...
def export_camt():
    ...
    download_link = XmlHandler.create_sample_camt053_data(
    ...
    if download_link:
        return (
            jsonify(
                {
                    "message": "Camt data created successfully!",
